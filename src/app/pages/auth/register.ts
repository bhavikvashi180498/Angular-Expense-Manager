                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-16 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <span class="text-muted-color font-medium">Join Expense Manager today</span>
                        </div>
                        ...
                        <div class="text-center mt-6">
                            ...
                            <a routerLink="/auth/login" class="font-medium no-underline ml-2 cursor-pointer text-primary">Sign In</a>
                        </div>
                    </div>
                </div>
            </div>
